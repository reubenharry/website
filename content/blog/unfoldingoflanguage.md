...
<!-- (I should also note that I am obviously not the first person to think about modeling this problem mathematically, or to use concepts from reinforcement learning, Bayesian inference, game theory and dynamical systems to do it. That said, I think I'm well positioned to have a novel perspective.) -->

## How to think about it

With those two influences in mind, here is my sense of the right kind of approach. Schematically, what I have in mind is a dynamical system, comprised of two agents coupled to a world. Graphically:
...
So suppose that agent 1 and agent 2 both believe that the other is using language $L$. Then they each act as if they are using language $L$, so that the signals the agents are exchanging actually do convey information. And voila, the system has language! This leads to what I think is the really interesting mystery at the heart of all this: how does the pair of agents acquire such a belief?
