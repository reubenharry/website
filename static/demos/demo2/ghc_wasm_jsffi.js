...
ZC6ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => {var t=$1.getTransform(); var s=Math.sqrt(Math.abs(t.a*t.d-t.b*t.c)); $1.lineWidth = s===0 ? $2 : ($2/s);},
ZC8ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.strokeStyle = $2),
ZC9ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.fillStyle = $2),
ZC10ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3,$4,$5) => ($1.strokeRect($2, $3, $4, $5)),
ZC11ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3,$4,$5) => ($1.fillRect($2, $3, $4, $5)),
ZC12ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.stroke()),
ZC13ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.fill()),
ZC14ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.arc(0, 0, $2, 0, 2 * Math.PI)),
ZC15ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.closePath()),
ZC16ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.beginPath()),
ZC17ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.rotate($2)),
ZC18ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.scale($2, $3)),
ZC19ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.translate($2, $3)),
ZC20ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.restore()),
ZC21ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.save()),
ZC22ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.clearRect(0, 0, $2, $3)),
ZC23ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.height),
ZC24ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.width),
ZC25ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.getContext('2d')),
ZC26ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => (document.getElementById($1)),
ZC1ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => (console.log($1)),
ZC2ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => {document.querySelectorAll('[data-btn]').forEach(function(el){ el.addEventListener('mousedown', function(){ $1(el.getAttribute('data-btn'), true); }); el.addEventListener('mouseup', function(){ $1(el.getAttribute('data-btn'), false); }); el.addEventListener('mouseleave', function(){ $1(el.getAttribute('data-btn'), false); }); });},
ZC3ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1,$2) => (document.getElementById($1).addEventListener('mouseup', function(){ $2(0, 0); })),
ZC4ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1,$2) => (document.getElementById($1).addEventListener('mousedown', function(e){ var r = e.target.getBoundingClientRect(); $2(e.clientX - r.left, e.clientY - r.top); })),
ZC5ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1,$2) => (document.getElementById($1).addEventListener('mousemove', function(e){ var r = e.target.getBoundingClientRect(); $2(e.clientX - r.left, e.clientY - r.top); })),
ZC6ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => (window.requestAnimationFrame($1)),
ZC8ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC7ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC($1, ...args)),
ZC10ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC9ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC($1, ...args)),
ZC12ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC11ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC($1, ...args)),
