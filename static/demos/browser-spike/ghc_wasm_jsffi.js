...
ZC0ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.lineTo($2, $3)),
ZC1ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.moveTo($2, $3)),
ZC2ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.lineWidth = $2),
ZC3ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.strokeStyle = $2),
ZC4ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.fillStyle = $2),
ZC5ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.stroke()),
ZC6ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.fill()),
ZC7ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2) => ($1.arc(0, 0, $2, 0, 2 * Math.PI)),
ZC8ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.beginPath()),
ZC9ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.scale($2, $3)),
ZC10ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.translate($2, $3)),
ZC11ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.restore()),
ZC12ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.save()),
ZC13ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1,$2,$3) => ($1.clearRect(0, 0, $2, $3)),
ZC14ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.height),
ZC15ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.width),
ZC16ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => ($1.getContext('2d')),
ZC17ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCCanvasZC: ($1) => (document.getElementById($1)),
ZC1ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => (console.log($1)),
ZC2ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1,$2) => (document.getElementById($1).addEventListener('click', function(){ $2($1, true); setTimeout(function(){ $2($1, false); }, 100); })),
ZC3ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1,$2) => (document.getElementById($1).addEventListener('mousemove', function(e){ var r = e.target.getBoundingClientRect(); $2(e.clientX - r.left, e.clientY - r.top); })),
ZC4ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => (window.requestAnimationFrame($1)),
ZC6ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC5ZCbrowserzmspikezm0zi1zi0zi0zminplacezmbrowserzmspikeZCMainZC($1, ...args)),
